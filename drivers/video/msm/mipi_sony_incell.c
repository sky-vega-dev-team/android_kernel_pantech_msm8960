...
#ifdef CONFIG_MACH_APQ8064_EF52L
{0, 25, 40, 50, 60, 70, 80, 90, 100, 115, 130, 145, 160, 175, 190, 205, 220};
#else
{0, 8, 25, 45, 60, 70, 80, 90, 100, 115, 130, 145, 160, 175, 190, 235, 255};//Le Hoang modify for battery saving
#endif
